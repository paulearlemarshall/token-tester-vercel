                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-surface-400 text-xs max-w-[120px] truncate">
                        {(() => {
                          ...
                          return fp ? (
                            <button
                              onClick={e => { e.stopPropagation(); window.electronAPI.openFile(fp) }}
                              className="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 truncate block max-w-full"
                              title={fp}
                            >
                              {r.file!.name}
                            </button>
