    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => window.electronAPI.openEnv()}
            className="btn-secondary text-xs flex items-center gap-1.5"
            title="Opens .env file in default editor"
          >
            <FileEdit size={14} />
            Edit .env
          </button>
          <button
            onClick={() => window.electronAPI.openPricingFile()}
            className="btn-secondary text-xs flex items-center gap-1.5"
            title="Opens user pricing JSON in default editor"
          >
            <DollarSign size={14} />
            Edit Pricing
          </button>
